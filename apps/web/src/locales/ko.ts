export default {
  ...
  landing: {
    ...
    pricing: {
      ...
      subtitle:
        "Start protecting your server today. All plans include our complete feature set.",
      popular_badge: "🏆 Most Popular",
      features: {
        instant_delivery: "Instant delivery",
        all_features: "All VexonAC Features",
      ...
      plans: {
        monthly: {
          ...
          price: "€50",
          period: "month",
          feature_1: "1 Month Access",
        },
        quarterly: {
          name: "Quarterly",
          price: "€100",
          period: "3 months",
          feature_1: "3 Months Access",
        },
        lifetime: {
          name: "Lifetime",
          price: "€250",
          period: "forever",
          feature_1: "Lifetime Access",
        },
      },
      premium: {
        ...
        description: "Expert installation and configuration service",
        perfect_for: "Perfect for large servers",
        expert_setup: "Expert setup & optimization",
        features: {
          installation: "Expert installation & configuration",
          optimization: "Custom optimization for your server",
          updates: "Pre-release updates access",
          premium_features: "Exclusive premium features",
          discount: "Discount on additional servers",
          support: "Priority 1-on-1 support",
        },
      },
      purchase: "Purchase",
